...
In order to support loading of multiple wallets in baas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is baas.cpp.
...
Changes to baas.cpp
----------------------
baas.cpp is the entry point into baas-qt, and as such, will require some minor modifications to provide hooks for
