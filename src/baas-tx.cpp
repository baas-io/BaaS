...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BaaS Core baas-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  baas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BaaS transaction") + "\n" +
                               "  baas-tx [options] -create [commands]   " + _("Create hex-encoded BaaS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BaaS transaction
