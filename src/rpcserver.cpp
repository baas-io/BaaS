...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BaaS features */
        {"baas", "masternode", &masternode, true, true, false},
        {"baas", "listmasternodes", &listmasternodes, true, true, false},
        {"baas", "getmasternodecount", &getmasternodecount, true, true, false},
        {"baas", "masternodeconnect", &masternodeconnect, true, true, false},
        {"baas", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"baas", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"baas", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"baas", "masternodecurrent", &masternodecurrent, true, true, false},
        {"baas", "masternodedebug", &masternodedebug, true, true, false},
        {"baas", "startmasternode", &startmasternode, true, true, false},
        {"baas", "createmasternodekey", &createmasternodekey, true, true, false},
        {"baas", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"baas", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"baas", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"baas", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"baas", "getmasternodescores", &getmasternodescores, true, true, false},
        {"baas", "mnsync", &mnsync, true, true, false},
        {"baas", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> baas-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10081/\n";
}
