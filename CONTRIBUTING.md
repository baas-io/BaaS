Contributing to BaaS Core
============================

The BaaS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BaaS Core project, and is not to be
confused with overall BaaS Network Protocol consensus changes.

Whether a pull request is merged into BaaS Core rests with the project merge
...
Patches that change BaaS consensus rules are considerably more involved than
...
Where a patch set proposes to change the BaaS consensus, it must have been
...
The project leader is the release manager for each BaaS Core release.
