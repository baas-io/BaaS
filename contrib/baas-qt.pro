...
RESOURCES += src/qt/baas.qrc src/qt/baas_locale.qrc

TRANSLATIONS += src/qt/locale/baas_bg.ts \
                src/qt/locale/baas_de.ts \
                src/qt/locale/baas_en.ts \
                src/qt/locale/baas_es.ts \
                src/qt/locale/baas_fi.ts \
                src/qt/locale/baas_fr.ts \
                src/qt/locale/baas_it.ts \
                src/qt/locale/baas_ja.ts \
                src/qt/locale/baas_pl.ts \
                src/qt/locale/baas_pt.ts \
                src/qt/locale/baas_ru.ts \
                src/qt/locale/baas_sk.ts \
                src/qt/locale/baas_sv.ts \
                src/qt/locale/baas_vi.ts \
                src/qt/locale/baas_zh_CN.ts \
                src/qt/locale/baas_zh_TW.ts
